...
-- AddForeignKey
ALTER TABLE "prescriptions" ADD CONSTRAINT "prescriptions_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patents"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
