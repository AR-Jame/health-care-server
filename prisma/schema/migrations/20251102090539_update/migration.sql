/*
  ...
  - You are about to drop the `doctor_schedule` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "public"."doctor_schedule" DROP CONSTRAINT "doctor_schedule_doctorId_fkey";

-- DropForeignKey
ALTER TABLE "public"."doctor_schedule" DROP CONSTRAINT "doctor_schedule_scheduleId_fkey";
